...
Jos näet virheitä kuvien näytössä, on suositeltavaa poistaa se käytöstä \(<img src="/resurssit/tyokalut/tools.png" /> [Asetukset &rarr; Käyttöliittymä]({{< ref "asetukset.md" >}})\).
