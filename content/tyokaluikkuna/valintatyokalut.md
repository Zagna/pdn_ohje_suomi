...
ja poissulkeva. Nopea ohje näihin komentoihin, katso [Näppäimistön ja hiiren komennot]({{< ref "nappaimisto_ja_hiiri.mmark" >}}). Lisäksi, valintoja voi siirtää, muuttaa kokoa 
...
on myös saatavilla [täällä]({{< ref "nappaimisto_ja_hiiri.mmark" >}}).)
