...
Protokollan käyttö onnistuu menemällä Käynnistä &rarr; Suorita (tai {{< keyb >}}Windows{{< /keyb >}} + {{< keyb >}}R{{< /keyb >}}) ja kirjoita paintdotnet:"tiedoston sijainti.jpg"
ja paina {{< keyb >}}Enteriä{{< /keyb >}}. Ohjelma käynnistyy ja kuva aukeaa.
