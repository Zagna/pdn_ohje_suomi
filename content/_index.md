...
* #### Avaa ja muokkaa useita tiedostoja
    ...
    Jokainen avoinna oleva kuva näkyy erillään Windowsin tehtäväpalkin esikatselussa
    (tämän voi ottaa pois päältä {{< tool "tools" >}}
    [Asetukset]({{% relref "asetukset" %}}) valikossa).
